...
def train(RL):
    ...
    for i_episode in range(1000):
        ...
        while True:
            ...
            indicator_list.append(observation_[0])
            ...
            if done == 2:
              ...
              if i_episode >= 990:
               ...
               saver.save(sess,
                          '/home/harry/PycharmProjects/car_rl/car/stable-baselines/stable_baselines/Jinghua/model.ckpt')
               # reader = tf.train.NewCheckpointReader("/home/yang/DQ/model.ckpt")
               ...
               for neu_num in range(20): 
                 for timestep in range(len(loc_list)):
                   layer1[neu_num][timestep] = indicator_list[timestep] * w1[0][neu_num] + vel_list[timestep]*w1[1][neu_num] + b1[0][neu_num]
